...
<div class="hidden lg:flex lg:w-5/12 flex-col justify-between p-12" style="background:linear-gradient(160deg,#f5ede0 0%,#eeddd0 100%)">
  ...
  <div>
    <h2 class="serif text-4xl leading-tight mb-4" style="color:var(--charcoal)">Create a new password.</h2>
    <p class="text-stone-500 leading-relaxed">Choose a strong password that is at least 6 characters long. You will be signed in immediately after.</p>
  </div>
...
<div class="flex-1 flex items-center justify-center px-4 py-16">
  <div class="w-full max-w-sm fade-in">
    <div class="mb-8">
      <h1 class="serif text-3xl mb-1" style="color:var(--charcoal)">Set new password</h1>
      <p class="text-stone-500 text-sm">Enter and confirm your new password below.</p>
    </div>
    ...
    <p class="text-center text-sm text-stone-500 mt-6">
      <a href="{{ route('login') }}" class="font-medium" style="color:var(--sage)">Back to Sign In</a>
    </p>
  </div>
</div>
@endsection
