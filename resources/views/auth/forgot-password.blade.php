...
<div class="hidden lg:flex lg:w-5/12 flex-col justify-between p-12" style="background:linear-gradient(160deg,#e8f0e8 0%,#d4e6d3 100%)">
  ...
  <div>
    <h2 class="serif text-4xl leading-tight mb-4" style="color:var(--charcoal)">Reset your password.</h2>
    <p class="text-stone-500 leading-relaxed">Enter your registered email address and we will send you a secure link to create a new password.</p>
  </div>
...
<div class="flex-1 flex items-center justify-center px-4 py-16">
  <div class="w-full max-w-sm fade-in">
    <div class="mb-8">
      ...
      <h1 class="serif text-3xl mb-1" style="color:var(--charcoal)">Forgot password?</h1>
      <p class="text-stone-500 text-sm">No worries — enter your email and we'll send a reset link.</p>
    </div>
    ...
    <p class="text-center text-sm text-stone-500 mt-6">
      Remember your password? <a href="{{ route('login') }}" class="font-medium" style="color:var(--sage)">Sign in</a>
    </p>
  </div>
</div>
@endsection
